...
walk(.x = files_list, 
     ...
     str_replace_all(pattern = '<div class="quarto-title-meta-heading">Authors</div><div class="quarto-title-meta-contents"><div class="quarto-title-authors">', 
         ...
         str_replace_all(pattern = '<div class="quarto-title-meta-heading">Author</div><div class="quarto-title-meta-contents"><div class="quarto-title-authors">', 
                         replacement = '<div class="quarto-title-meta-heading">Team Members</div><div class="quarto-title-meta-contents"><div class="quarto-title-authors">') |> 
         ## change "Published" heading to "Year" ----
     str_replace_all(pattern = '<div class="quarto-title-meta-heading">Published</div><div class="quarto-title-meta-contents">', 
                     replacement = '<div class="quarto-title-meta-heading">Year</div><div class="quarto-title-meta-contents">') |> 
         ## save modified file ----
     write_file(file = here('docs', 'projects', .x), 
                append = FALSE)
)
